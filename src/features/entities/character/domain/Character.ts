import { getItemById } from '../../../../config/globalFunctions.js';
import { itemRegistry } from '../../../../data/itemLoader.js';
import { BodySlot, ItemType, type Armory } from '../../../items/index.js';
import { Progression } from '../../../progression/Progression.js';
import { Classes, type Attributes, type Class, type Entity, type LevelInfo, type Vitals } from '../../index.js';
...
export class Character implements Entity {
  ...
  equipArmor(itemId: string) {
    const armor = getItemById(itemId)
